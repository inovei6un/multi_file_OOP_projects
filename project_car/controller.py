from some_projects.project_testing_library import Driver
from some_projects.project_testing_library import Race
from some_projects.project_testing_library import CarFactory
...
class Controller:
    ...
    def add_driver_to_race(self, race_name, driver_name):
        race = self.__find_if_race_exists(race_name)
        driver = self.__find_driver_by_name(driver_name)
    ...
    def __find_if_race_exists(self, race_name):
