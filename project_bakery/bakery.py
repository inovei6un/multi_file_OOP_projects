from project_bakery.validator.drink_factory import DrinkFactory
from project_bakery.validator.food_factory import FoodFactory
from project_bakery.validator.table_factory import TableFactory
...
class Bakery:
    ...
    @name.setter
    def name(self, value):
        Validator.raise_if_empty_string_or_whitespace(value, f'Name cannot be empty or white space!')
        self.__name = value
